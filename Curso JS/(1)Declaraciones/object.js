...
console.log(objeto[variable]); //Retorna "Masculino" //Es como si pusiera Console.log(objeto.sexo)
...
console.log(objeto.sexo); //Retorna undifined
 ...
 //Desestructuracion
const {nombre, tiempo} = objeto; //Desestructuracion de objetos, se crean dos variable con el nombre del atributo y se le asigna el valor del atributo

 //Crear Funciones dentro de objetos
const test={
